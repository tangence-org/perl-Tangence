...
$obj->watch_property( 'scalar', sub { @s_event = @_ } );

$obj->set_prop_scalar( "456" );
is( $obj->get_prop_scalar, "456", 'scalar after set' );
is_deeply( \@s_event, [ CHANGE_SET, "456" ], '@event after set' );
